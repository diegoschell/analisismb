...
test <- as.data.frame(read.csv(file = "ultimaversion/imgdic-sojamarzoLASECcosecha1.csv", header = T))
names(test) <- c("Dryield", "HarvestM", "YieldMas","YieldWet", "EVI", "NDVI", "LAI")
testlote1 <- as.data.frame(read.csv(file = "ultimaversion/imgdic-sojamarzoLASECcosecha1.csv", header = T))
...
source("multiplot.R")
multiplot(p1, p2, p3, p4, p5, p6, p7, p8, p10, p11, p12, p13, p14, p15, p16, p17, p18, cols=3)
