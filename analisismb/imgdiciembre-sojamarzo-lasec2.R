...
testlote1 <- as.data.frame(read.csv(file = "owncloud/7-aplicaciones/monte-buey/analisis/ultimaversion/imgdic-sojamarzoLASEC2.csv", header = T))
...
multiplot(p1, p2, p3, p4, p5, p6, p7, p8, p10, p11, p12, p13, p14, p15, p16, p17, cols=3)
