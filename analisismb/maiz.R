...
testlote1 <- as.data.frame(read.csv(file = "owncloud/7-aplicaciones/monte-buey/analisis/maiz.csv", header = T))
# asigno un nombre a cada columna de mi dataframe
names(testlote1) <- c("Dryield", "HarvestM", "YieldMas", "YieldWet", "RVI", "EVI", "RVIfeb", "GNDVI", "NDI45", "MSAVI", "MCARI", "REIP", "NDVI", "IRECI", "toREP")
