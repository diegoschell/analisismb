...
testlote1 <- as.data.frame(read.csv(file = "ultimaversion/imgdic-sojamabrilCMB3.csv", header = T))
# asigno un nombre a cada columna de mi dataframe
names(testlote1) <- c("Dryield", "HarvestM", "YieldMas","YieldWet", "GNDVI", "IRECI", "MCARI", "MSAVI", "MTCI", "NDI45",
                     "NDVI", "REIP", "SAVI", "TNDVI", "S2REP", "EVI", "TSAVI", "LAI", "GEMI")
...
multiplot(p11, p12, p13, p14, p15, p16, p17, cols=3)
