...
testlote1 <- as.data.frame(read.csv(file = "ultimaversion/imgfeb-maizabrilCMB1.csv", header = T))
...
p15 <- ggplot(testlote1, aes(x = YieldMas, y = LAI)) + geom_smooth(method = lm, se = FALSE) + geom_point() + ggtitle("LAI") + labs(x = "Rendimiento ton/ha")+ theme(axis.text=element_text(size=10),axis.title=element_text(size=9,face="plain"))
#p16 <- ggplot(testlote1, aes(x = YieldMas, y = FPAR)) + geom_smooth(method = lm, se = FALSE) + geom_point() + ggtitle("FPAR") + labs(x = "Rendimiento ton/ha")+ theme(axis.text=element_text(size=10),axis.title=element_text(size=9,face="plain"))
p17 <- ggplot(testlote1, aes(x = YieldMas, y = RVI)) + geom_smooth(method = lm, se = FALSE) + geom_point() + ggtitle("RVI") + labs(x = "Rendimiento ton/ha")+ theme(axis.text=element_text(size=10),axis.title=element_text(size=9,face="plain"))
#ploteo graficos
...
multiplot(p11, p12, p13, p14, p15, p17, cols=3)
